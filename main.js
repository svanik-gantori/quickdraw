...
document.getElementById("drawnsketch").innerHTML="Sketch to be drawn: "+sketch;
var timer_counter=0;
var timer_check="";
var drawn_sketch="";
answer_holder="";
...
function gotResult(results,error)
{
    ...
    document.getElementById("confidence").innerHTML=Math.round(Math.floor(result[0].confidence)*100)+"%";
}
...
function check_sketch()
{
    ...
    if(timer_check==0||answer_holder=="set")
    {
        timer_check=0;
        answer_holder="";
        updateCanvas();
